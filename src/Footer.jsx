    ...
    return (
        <Container component="footer" maxWidth={false} sx={{ padding: '2rem', backgroundColor: '#f1f1f1', overflowX: 'hidden' }}>
            <Box sx={{ display: 'flex', flexDirection: { xs: 'column', sm: 'row' }, justifyContent: 'space-between', flexWrap: 'wrap' }}>
                ...
                <Box sx={{ flex: 1, marginBottom: '1rem', marginRight: { sm: '1rem' } }}>
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', marginBottom: '1rem' }}>
                        ...
                        <Typography variant="body2">
                            Email: <MuiLink href="mailto:RayGen@gmail.com" sx={{ color: 'black' }}>RayGen@gmail.com</MuiLink>
                        </Typography>
                    </Box>
                    <Box sx={{ display: 'flex', alignItems: 'center', marginBottom: '1rem' }}>
            ...
            <Box sx={{ marginTop: '2rem', borderTop: '1px solid #ccc', paddingTop: '1rem', textAlign: 'center' }}>
                <Typography variant="body2">
                    © {new Date().getFullYear()} Copyright: Raygen Solar Solutions. All Rights Reserved.
                </Typography>
            </Box>
        </Container>
    );
